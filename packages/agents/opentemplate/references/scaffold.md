...
> 见模板原文(`E:/opencode/oepntemplate/features/notes/components/notes-table.tsx`)
> 约 130 行,内容稍长 —— 直接 `Read` 复制即可。

## [57] `features/notes/components/note-form.tsx`

> 见模板原文(`E:/opencode/oepntemplate/features/notes/components/note-form.tsx`)。

## [58] `features/notes/components/note-delete-dialog.tsx`

> 见模板原文(`E:/opencode/oepntemplate/features/notes/components/note-delete-dialog.tsx`)。
...
直接从模板拷贝:`E:/opencode/oepntemplate/public/favicon.png`。或放任意 32×32 png。
